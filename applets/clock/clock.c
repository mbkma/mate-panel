...
edit_tree_row (GtkTreeModel *model, GtkTreePath *path, GtkTreeIter *iter, gpointer data)
{
        ...
        gweather_location_entry_set_city (GWEATHER_LOCATION_ENTRY(cd->location_entry),
...
ensure_prefs_window_is_created (ClockData *cd)
{
        ...
        cd->location_entry = gweather_location_entry_new (world);
        ...
        cd->zone_combo = gweather_timezone_menu_new (world);
